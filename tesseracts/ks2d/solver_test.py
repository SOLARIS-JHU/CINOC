...
def solve_with_policy(u_init, xi_fixed, u_target, params, policy_apply_fn, t_steps, N_grid=128, L=64.0, dt=0.05, sigma=1.0):
    dx = L / N_grid
    ...
    _, trajectory = jax.lax.scan(step_fn, (u_hat_init, u_init), None, length=t_steps)
    return trajectory
...
if __name__ == "__main__":
    N_GRID = 128  
    L_DOMAIN = 64.0 
    DT = 0.01  # <--- Crucial: Keep this small
    N_STEPS = 2000 
