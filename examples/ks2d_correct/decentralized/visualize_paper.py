...
def create_paper_figure(t_axis, u_controlled, u_natural, save_name="ks2d_paper_figure.pdf"):
    """
...
if __name__ == "__main__":
    ...
    create_paper_figure(t_axis, u_controlled, u_natural, save_name="ks2d_paper_figure.pdf")
