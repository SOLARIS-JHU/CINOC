...
def train(
    ...
    save_repo="./", 
    plot_filename='ks_centralized_training', 
    net_params_filename='ks_centralized_params', 
    plot_metrics=True
):
    """
    Trains a centralized ControlNet policy to stabilize the 1D Kuramoto-Sivashinsky equation.
    """
    ...
    model = ControlNet(features=(64, 64), L_domain=L_domain)
