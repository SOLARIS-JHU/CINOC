...
CONFIG = {
    ...
    'dt': 0.0005,           # Physics timestep
    'viscosity': 5e-5,    # Fluid viscosity
    
    # Action Repetition settings
    'substeps': 20,       # 16 Physics steps per Control step (matches solver stability)
    'T_steps': 100,        # 50 Control steps
...
def loss_fn(params, w_hat_init, xi_fixed, dynamics):
    ...
    total_loss = l_enstrophy + 1e-3 * l_effort
...
if __name__ == "__main__":
    ...
    lr_schedule = optax.warmup_cosine_decay_schedule(
        init_value=1e-4, peak_value=5e-4, warmup_steps=5, # was 50 !!! 
