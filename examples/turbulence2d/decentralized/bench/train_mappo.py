...
from examples.turbulence2d.decentralized.bench.models_mappo import MAPPOActorTurb, MAPPOCriticTurb
...
# 7. EXECUTION LOOP
# ==========================================
actor = MAPPOActorTurb(n_agents=N_AGENTS, u_max=U_MAX)
critic = MAPPOCriticTurb(n_agents=N_AGENTS)
...
actor_state = TrainState.create(
    ...
    params=actor.init(act_k, dummy_patches, dummy_pe),
...
with open(models_dir / 'mappo_turb_params.msgpack', 'wb') as f:
