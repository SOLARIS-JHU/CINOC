...
def main():
    ...
    with solver_ts:
        ...
        try:
            ...
            print(f"Loaded decentralized FKPP parameters for {n_agents} agents.")
        ...
        plt.tight_layout()
        plt.savefig('fkpp_decentralized_visual.png')
        print("Visualization saved to fkpp_decentralized_visual.png")
