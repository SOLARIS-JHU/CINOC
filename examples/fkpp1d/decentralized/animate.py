...
def create_side_by_side_animation(x_grid, z_target, z_traj_ctrl, z_traj_unctrl, 
    ...
    fig.suptitle('Fisher-KPP: Decentralized DPC vs Uncontrolled', fontsize=28, fontweight='bold', y=0.98)
...
def main():
    print("=" * 60)
    print("  FISHER-KPP DECENTRALIZED DPC - ANIMATION GENERATOR")
    print("=" * 60)
    ...
    with solver_ts:
        ...
        gif_path = 'fkpp_decentralized_animation.gif'
        ...
        try:
            print("▶ Saving MP4...")
            mp4_path = 'fkpp_decentralized_animation.mp4'
