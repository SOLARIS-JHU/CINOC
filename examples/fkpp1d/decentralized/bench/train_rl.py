...
def parallel_physics_step(z_batch, xi_batch, target_batch, actions, key):
    ...
    # Global margin penalty for agents moving out of bounds
    margin = 0.02
    ...
    rewards_batch = -mse - 10.0 * mean_oob_penalty
...
print("Starting Massively Parallel Centralized RL Training (FKPP)...")
...
# Save
with open('models/rl_fkpp_params.msgpack', 'wb') as f:
