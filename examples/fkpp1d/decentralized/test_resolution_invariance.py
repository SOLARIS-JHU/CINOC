...
# --- 2. Policy Definition (Must match training exactly) ---
...
def main():
    ...
    # Pre-compile the runner if possible, or just let JAX handle JIT cache
    # Since shapes change, we rely on JAX's cache for each resolution bucket
    ...
    for n_agents in tqdm(agent_counts, desc="Agents"):
        for res in resolutions:
            ...
            # JIT compile run wrapper for this specific shape
            # We do this inside loop, but JAX caches compiled functions based on shape
