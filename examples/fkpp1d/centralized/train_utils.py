...
def train(n_pde=100, n_agents=20, batch_size=32, T_steps=300, R_safe=0.05, epochs=500, noise_u=0.0, noise_z=0.0, save_repo="./", plot_filename='centralized_training', net_params_filename='centralized_training', plot_metrics=True):
    CONFIG = {
