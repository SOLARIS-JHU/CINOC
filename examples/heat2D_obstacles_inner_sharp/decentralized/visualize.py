...
def main():
    ...
    pdf_path = output_dir / 'heat2d_obstacles_inner_sharp_decentralized_visualization.pdf'
    plt.savefig(pdf_path, format='pdf', dpi=300, bbox_inches='tight')
    print(f"\n✓ Saved: {pdf_path}")

    # Also save as high-res PNG
    png_path = output_dir / 'heat2d_obstacles_inner_sharp_decentralized_visualization.png'
