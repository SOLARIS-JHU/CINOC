...
if args.test:
    print("=" * 50)
    print("RUNNING IN TEST MODE (DECENTRALIZED, INNER OBSTACLES - SHARP PENALTY)")
    print("=" * 50)
    n_samples = 1
    batch_size = 1
...
R_safe = 0.05  # Collision radius in 2D
...
def loss_fn(params, z_init, xi_init, z_target, dynamics):
    ...
    # SHARP PENALTY: Only penalize when inside obstacle
...
# Save parameters
with open('decentralized_params_heat2d_obstacles_inner_sharp.msgpack', 'wb') as f:
    f.write(flax.serialization.to_bytes(params))
print("Parameters saved to decentralized_params_heat2d_obstacles_inner_sharp.msgpack")
...
if metrics:
    ...
    plt.tight_layout()
    plt.savefig('training_metrics_heat2d_obstacles_inner_sharp_decentralized.png')
    print("Training metrics saved to training_metrics_heat2d_obstacles_inner_sharp_decentralized.png")
