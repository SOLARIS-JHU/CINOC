...
# Save parameters
params_path = script_path / 'centralized_params_heat2d_obstacles_inner_sharp.msgpack'
...
if metrics:
    ...
    plt.tight_layout()
    metrics_path = script_path / 'training_metrics_heat2d_obstacles_inner_sharp.png'
