...
"""
2D Heat Equation Control with Obstacles - Centralized Animation
...
def main():
    print("=" * 70)
    print("  2D HEAT EQUATION WITH OBSTACLES - CENTRALIZED ANIMATION")
    print("=" * 70)
    ...
    gif_path = 'heat2d_obstacles_animation.gif'
    ...
    try:
        ...
        mp4_path = 'heat2d_obstacles_animation.mp4'
