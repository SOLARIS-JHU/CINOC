"""
Paper-Quality Visualization for NS2D Density/Smoke Control.
Three rows:
...
Same style as heat2d: contourf, cmcrameri colormaps, Times New Roman fonts.
"""
...
from examples.density.decentralized.dynamics import unroll_controlled, ns2d_step_jax, compute_wasserstein_loss
...
CONFIG = {
    ...
    'params_file': 'ns2d_decentralized_params.msgpack'
}
...
def plot_snapshot_row(ax_list, smoke_traj, xi_traj, timesteps, v_lim, rho_target=None, show_agents=False):
    ...
    for i, t in enumerate(timesteps):
        ...
        cf = ax.contourf(
            X, Y, smoke_snap,
            levels=levels,
            # cmap='inferno',  # Vibrant colormap for smoke density
            cmap = cmc.vik,
            extend='max'
        )
...
def create_paper_figure(smoke_traj_ctrl, smoke_traj_unctrl, xi_traj_ctrl, vel_traj_ctrl,
                        ...
                        save_name="density_paper_figure.pdf"):
    """
    ...
    # cbar.set_label('Smoke Density', fontsize=10)
...
if __name__ == "__main__":
    print("=" * 60)
    print("NS2D Density Control - Paper Figure Generation")
    print("=" * 60)
