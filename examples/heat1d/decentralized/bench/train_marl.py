...
# --- Configurations ---
N_AGENTS = 8 # Updated to match Heat DPC defaults
L_DOMAIN = 1.0
N_GRID = 100
...
def extract_patches_jax(full_state, target_st, xi_n, window_size):
    ...
    # ZERO BOUNDARY padding for Heat
...
print("Starting Massively Parallel MARL Training (Heat Equation)...")
