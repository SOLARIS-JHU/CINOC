...
def create_comparison_figure(x_grid, z_init, z_target, z_traj_ctrl, z_traj_unctrl, 
    ...
    ax2.set_title(r"ControlledEvolution", fontsize=title_fs, fontweight='bold')
    ...
    save_path = f'heat_dpc_decentralized_row_ex{example_idx}.pdf'
...
def main():
    ...
    with solver_ts:
        ...
        for i in range(n_examples):
            ...
            # Create comparison figure (1x3 Row)
            ...
            # Removed separate agent analysis figure as requested
