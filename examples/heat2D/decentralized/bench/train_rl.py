...
def parallel_physics_step(z_batch, xi_batch, target_batch, actions, prev_v_batch, key):
    ...
    # --- Formulate Global Reward (MSE + Mean Penalties) safely shaped as (BATCH, 1) ---
    
    # 1. MSE: Reduce axes 1 and 2, then expand to (BATCH, 1)
...
print("Starting Massively Parallel Centralized RL Training (2D Heat Equation)...")
