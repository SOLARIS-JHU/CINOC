"""Visualization script for Centralized 2D Heat Control using Tesseract-JAX and Heat2DControlNet policy."""
import jax
...
def main():
    n_grid = 32  # Changed from 64 to match training default
    n_agents = 16
    T_steps = 300
    ...
    with solver_ts:
        ...
        plt.savefig('heat2d_centralized_visualization.png', dpi=150)
        print("\nSaved: heat2d_centralized_visualization.png")
