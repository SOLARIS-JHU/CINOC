...
if args.test:
    print("=" * 50)
    print("RUNNING IN TEST MODE (DECENTRALIZED, INNER OBSTACLES - CONTINUOUS PENALTY)")
    print("=" * 50)
    n_samples = 1
    batch_size = 1
...
# Save parameters
with open('decentralized_params_heat2d_obstacles_inner.msgpack', 'wb') as f:
    f.write(flax.serialization.to_bytes(params))
print("Parameters saved to decentralized_params_heat2d_obstacles_inner.msgpack")
...
if metrics:
    ...
    plt.tight_layout()
    plt.savefig('training_metrics_heat2d_obstacles_inner_decentralized.png')
    print("Training metrics saved to training_metrics_heat2d_obstacles_inner_decentralized.png")
