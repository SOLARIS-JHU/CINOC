...
# Save parameters
params_path = script_path / 'decentralized_params_heat2d_obstacles_inner.msgpack'
...
if metrics:
    ...
    plt.tight_layout()
    metrics_path = script_path / 'training_metrics_heat2d_obstacles_inner_decentralized.png'
