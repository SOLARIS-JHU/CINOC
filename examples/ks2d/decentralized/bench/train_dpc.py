"""
Centralized Deep Policy Control Training Script for 2D Kuramoto-Sivashinsky (KS)
...
CONFIG = {
    ...
    'model_save_name': 'models/dpc_ks2d_params.msgpack'
}
...
if __name__ == "__main__":
    print(f"--- 2D KS Control Training (DPC) ---")
    key = jax.random.PRNGKey(42)
    ...
    model = CentralizedMLPControlNet2D_KS(hidden_dim=256, n_agents=CONFIG['n_agents'], u_max=5.0)
    ...
    print(f"Saved DPC parameters to {CONFIG['model_save_name']}")
