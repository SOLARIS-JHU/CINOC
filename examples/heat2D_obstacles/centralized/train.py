...
if args.test:
    print("=" * 50)
    print("RUNNING IN TEST MODE (WITH OBSTACLES)")
    print("=" * 50)
    n_samples = 1
    batch_size = 1
...
# Save parameters
with open('centralized_params_heat2d_obstacles.msgpack', 'wb') as f:
    f.write(flax.serialization.to_bytes(params))
print("Parameters saved to centralized_params_heat2d_obstacles.msgpack")
...
if metrics:
    ...
    plt.tight_layout()
    plt.savefig('training_metrics_heat2d_obstacles.png')
    print("Training metrics saved to training_metrics_heat2d_obstacles.png")
