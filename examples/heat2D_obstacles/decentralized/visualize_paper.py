...
def draw_obstacles(ax, obstacles):
    ...
    for obs in obstacles:
        ...
        circle = Circle((x, y), r, color='gray', alpha=0.6,
...
def create_paper_figure(z_traj_ctrl, z_traj_unctrl, xi_traj_ctrl, z_target,
    ...
    fig = plt.figure(figsize=(7.5, 5.2))  # Adjusted height
    ...
    gs_main = gridspec.GridSpec(3, n_snaps + 1, 
                                 ...
                                 hspace=0.35, wspace=0.03)  # Reduced hspace
    ...
    cbar = fig.colorbar(cf, cax=cax, format='%.2f')  # 2 decimal places
