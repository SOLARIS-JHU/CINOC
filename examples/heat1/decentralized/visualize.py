...
def main():
    ...
    solver_ts = Tesseract.from_image("solver_heat_decentralized:latest") # Use the image with the flat-vector API
    ...
    with solver_ts:
        ...
        plt.tight_layout()
        plt.savefig('decentralized_visual_results.png')
        print("Visualization saved to decentralized_visual_results.png")
